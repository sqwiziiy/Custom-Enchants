...
Version `3.2.2` · Minecraft `1.21.1` · Fabric · Java `21` · [Releases](https://github.com/sqwiziiy/Custom-Enchants/releases) · [Documentation](https://sqwiziiy.github.io/Custom-Enchants/) · [Issues](https://github.com/sqwiziiy/Custom-Enchants/issues)
...
Download `custom-enchants-3.2.2-mc1.21.1.jar` from the [Minecraft 1.21.1 release](https://github.com/sqwiziiy/Custom-Enchants/releases/tag/v3.2.2-mc1.21.1) and place it in the Fabric `mods/` directory. Required dependencies are Fabric Loader `>=0.19.3`, Fabric API `>=0.116.15+1.21.1`, Cloth Config `>=15.0.140`, and Java `>=21`; Mod Menu `>=11.0.4` is optional.

For Minecraft 1.20.1, use the [v3.2.2 release](https://github.com/sqwiziiy/Custom-Enchants/releases/tag/v3.2.2) from the [`3.2/1.20.1`](https://github.com/sqwiziiy/Custom-Enchants/tree/3.2/1.20.1) branch instead.
