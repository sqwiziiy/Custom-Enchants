...
Version `3.2.2` · Minecraft `1.20.1` · Fabric · Java `17` · [Releases](https://github.com/sqwiziiy/Custom-Enchants/releases) · [Documentation](https://sqwiziiy.github.io/Custom-Enchants/) · [Issues](https://github.com/sqwiziiy/Custom-Enchants/issues)
...
- [3.2.2 release notes](RELEASE_NOTES_3.2.2.md)
...
Download `custom-enchants-3.2.2.jar` from the [3.2.2 release](https://github.com/sqwiziiy/Custom-Enchants/releases/tag/v3.2.2) and place it in the Fabric `mods/` directory. Required dependencies are Fabric Loader `>=0.18.4`, Fabric API `>=0.92.7+1.20.1`, Cloth Config `>=11.1.118`, and Java `>=17`; Mod Menu `>=7.2.2` is optional.
